/**
 * This is a port of the command score algorithm from the original
 * `pacocoursey/cmdk` package. It can be found here:
...
export const score: (
  ...
  search: string,
  keywords?: string[],
) => number = (value, search, keywords) =>
  value ? commandScore(value, search, keywords) : 0
